...
router.get('/members/:id', authAdmin, Controller.getMemberById); 
router.put('/members/:id', authAdmin, Controller.updateMember); 
router.patch('/members/:id', authAdmin, Controller.updateStatus)
